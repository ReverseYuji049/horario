...
| :---------------: | -------------- | ----------------- | ------------------------------- | ---------------------------------------------------- | :--------------------: |
| **Segunda** | Java Udemy     | Expressão Lambda | Python/Inteligência Artificial | Filtragem, Panda Data Frame, Manipulação de String |   Trabalho Final UML   |
| **Terça** | —             | —                | —                              | —                                                   |           —           |
| **Quarta** | —             | —                | —                              | —                                                   |           —           |
| **Quinta** | Grupo de Jogos | Atribuição de Tarefas               | Grupo de Jogos                  | —                                                   |           —           |
